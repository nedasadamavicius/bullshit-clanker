defmodule BC.Permit do
  @moduledoc """
  Single-use write permit for applying patches (I4).

  A permit is minted only by BC.TUI on an explicit accept keypress,
  and consumed once by BC.Patch.Apply. Each permit is valid for 5 minutes
  ...
  @ets_table_name :bc_permit_spent
