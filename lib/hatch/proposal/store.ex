defmodule Hatch.Proposal.Store do
  @moduledoc """
  ...
  @spec put(t(), Hatch.Proposal.t()) :: :ok
  ...
  @spec pending(t(), String.t()) :: {:ok, Hatch.Proposal.t()} | :none
  ...
  @spec get(t(), String.t(), String.t()) :: {:ok, Hatch.Proposal.t()} | {:error, :not_found}
