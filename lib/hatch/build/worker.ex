defmodule Hatch.Build.Worker do
  use GenServer
  require Logger
  ...
  def build(session_id, opts) do
    builder = Application.get_env(:hatch, :builder, __MODULE__)
    ...
    case System.find_executable(config.tamago_go) do
      nil ->
        {:error,
         %{
           code: :no_toolchain,
           message: "tamago-go not found on PATH (HATCH_TAMAGO_GO=#{config.tamago_go})"
         }}
