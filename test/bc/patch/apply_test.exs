defmodule BC.Patch.ApplyTest do
  use ExUnit.Case
  alias BC.{Proposal, Patch, Permit}
  ...
  setup do
    ...
    case System.find_executable("git") do
      ...
      _git_path ->
        ...
        tmpdir =
          Path.join(System.tmp_dir!(), "bc_apply_test_#{:erlang.unique_integer([:positive])}")

        File.mkdir_p!(tmpdir)

        # Configure sandbox with test tree_root
        Application.put_env(:bc, :tree_root, tmpdir)
