defmodule Hatch.TUI.ModelTest do
  use ExUnit.Case
  ...
  describe "user input events" do
    test "user_message event appends to transcript", %{model: model} do
      event = {:hatch_event, %{type: :user_message, text: "hello", session_id: "s_test123"}}
    ...
    test "assistant_delta events append to last assistant line", %{model: model} do
      event1 = {:hatch_event, %{type: :user_message, text: "hello", session_id: "s_test123"}}
      event2 = {:hatch_event, %{type: :assistant_delta, text: "hi", session_id: "s_test123"}}
      event3 = {:hatch_event, %{type: :assistant_delta, text: " there", session_id: "s_test123"}}
    ...
    test "assistant_message event adds new assistant message", %{model: model} do
      event =
        {:hatch_event,
         %{type: :assistant_message, text: "full response", session_id: "s_test123"}}
